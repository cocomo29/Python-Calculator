...
en_box=tk.Entry(win,width=50,relief='solid',bg='deep sky blue',fg='black',font="lucida 10 bold")
en_box.grid(row=0,column=0,columnspan=5,padx=5,pady=10)
win.iconbitmap('calculatorico.ico')
...
seven=tk.Button(win,text="7",relief='raised',padx=30,pady=10,fg="white",bg="deep sky blue",command=lambda:click('7'))
seven.grid(row=4,column=1)

eight=tk.Button(win,text="8",relief='raised',padx=30,pady=10,fg="white",bg="deep sky blue",command=lambda:click('8'))
eight.grid(row=4,column=2)

nine=tk.Button(win,text="9",relief='raised',padx=30,pady=10,fg="white",bg="deep sky blue",command=lambda:click('9'))
...
four=tk.Button(win,text="4",relief='raised',padx=30,pady=10,fg="white",bg="deep sky blue",command=lambda:click('4'))
four.grid(row=5,column=1)

five=tk.Button(win,text="5",relief='raised',padx=30,pady=10,fg="white",bg="deep sky blue",command=lambda:click('5'))
five.grid(row=5,column=2)

six=tk.Button(win,text="6",relief='raised',padx=30,pady=10,fg="white",bg="deep sky blue",command=lambda:click('6'))
...
one=tk.Button(win,text="1",relief='raised',padx=30,pady=10,fg="white",bg="deep sky blue",command=lambda:click('1'))
one.grid(row=6,column=1)

two=tk.Button(win,text="2",relief='raised',padx=30,pady=10,fg="white",bg="deep sky blue",command=lambda:click('2'))
two.grid(row=6,column=2)

three=tk.Button(win,text="3",relief='raised',padx=30,pady=10,fg="white",bg="deep sky blue",command=lambda:click('3'))
...
exit=tk.Button(win,text="exit",relief='raised',padx=23,pady=10,fg="red",bg="black",command=win.destroy)
...
zero=tk.Button(win,text="0",relief='raised',padx=30,pady=10,fg="white",bg="deep sky blue",command=lambda: click("0"))
...
def msg():
    messagebox.showinfo("Credits", "made by blurryface and cocomo") 

owo=tk.Button(win,text="credits",relief='raised',padx=15,pady=10,fg="red",bg="black",command=msg)
